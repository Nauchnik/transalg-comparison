...
bout = breg_init[147] && !breg_init[148] && breg_init[149] && breg_init[150] && breg_init[151];
bout &&= !breg_init[152] && breg_init[153] && breg_init[154] && breg_init[155] && !breg_init[156];
bout &&= !breg_init[157] && !breg_init[158] && breg_init[159] && breg_init[160] && !breg_init[161];
bout &&= breg_init[162] && !breg_init[163] && !breg_init[164] && !breg_init[165] && !breg_init[166];
bout &&= breg_init[167] && !breg_init[168] && !breg_init[169] && breg_init[170] && breg_init[171];
bout &&= breg_init[172] && breg_init[173] && !breg_init[174] && !breg_init[175] && !breg_init[176];
