...
bout = breg_init[148] && breg_init[149] && breg_init[150] && !breg_init[151] && !breg_init[152];
bout &&= breg_init[153] && !breg_init[154] && breg_init[155] && !breg_init[156] && !breg_init[157];
bout &&= !breg_init[158] && breg_init[159] && breg_init[160] && !breg_init[161] && !breg_init[162];
bout &&= breg_init[163] && !breg_init[164] && breg_init[165] && breg_init[166] && !breg_init[167];
bout &&= breg_init[168] && breg_init[169] && !breg_init[170] && breg_init[171] && breg_init[172];
bout &&= !breg_init[173] && !breg_init[174] && !breg_init[175] && !breg_init[176] && breg_init[177];
bout &&= !breg_init[178] && breg_init[179] && !breg_init[180] && !breg_init[181] && !breg_init[182];
bout &&= breg_init[183] && breg_init[184] && breg_init[185] && !breg_init[186] && !breg_init[187];
bout &&= !breg_init[188] && !breg_init[189] && !breg_init[190] && breg_init[191] && !breg_init[192];
bout &&= breg_init[193] && breg_init[194] && !breg_init[195] && !breg_init[196] && breg_init[197];
bout &&= breg_init[198] && breg_init[199] && breg_init[200] && breg_init[201] && breg_init[202];
bout &&= breg_init[203] && !breg_init[204] && breg_init[205] && breg_init[206] && !breg_init[207];
bout &&= !breg_init[208] && breg_init[209] && !breg_init[210] && !breg_init[211] && !breg_init[212];
bout &&= !breg_init[213] && breg_init[214] && !breg_init[215] && breg_init[216] && breg_init[217];
bout &&= breg_init[218] && !breg_init[219] && breg_init[220] && breg_init[221] && breg_init[222];
bout &&= !breg_init[223] && !breg_init[224] && breg_init[225] && breg_init[226] && !breg_init[227];
bout &&= !breg_init[228] && !breg_init[229] && !breg_init[230] && !breg_init[231] && breg_init[232];
bout &&= !breg_init[233] && !breg_init[234] && breg_init[235] && !breg_init[236] && breg_init[237];
bout &&= !breg_init[238] && !breg_init[239] && breg_init[240] && breg_init[241] && !breg_init[242];
bout &&= !breg_init[243] && breg_init[244] && !breg_init[245] && breg_init[246] && !breg_init[247];
bout &&= !breg_init[248] && breg_init[249] && breg_init[250] && breg_init[251] && !breg_init[252];
bout &&= breg_init[253] && !breg_init[254] && breg_init[255] && !breg_init[256] && breg_init[257];
bout &&= breg_init[258] && !breg_init[259] && breg_init[260] && !breg_init[261] && breg_init[262];
bout &&= breg_init[263] && breg_init[264] && breg_init[265] && breg_init[266] && !breg_init[267];
bout &&= !breg_init[268] && !breg_init[269] && !breg_init[270] && !breg_init[271] && !breg_init[272];
bout &&= !breg_init[273] && breg_init[274] && breg_init[275] && !breg_init[276] && breg_init[277];
bout &&= breg_init[278] && breg_init[279] && !breg_init[280] && !breg_init[281] && breg_init[282];
bout &&= !breg_init[283] && !breg_init[284] && breg_init[285] && !breg_init[286] && !breg_init[287];
